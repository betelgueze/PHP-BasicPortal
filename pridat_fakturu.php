...
<TR height="70%">
	...
	<TD width="85%" colspan="2" align="center" valign="center"><h2>Pridat fakturu k aktualni zakazce:</h2><br>
		<form method="post" action="pridat_fakturu_sql.php">
			Hodnota: <input type="text" name="hodnota" size="20">
			Datum splatnosti: <input type="text" name="splatnost" size="20" value="<?php echo date("j.n.Y");?>"><br><br> 
			<input type="submit" value="Pridat fakturu"> 
		</form> 
	</TD>
</TR>
</table>
