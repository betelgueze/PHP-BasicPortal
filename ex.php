...
<TR height="70%">
	...
	<TD width="85%" colspan="2" align="center" valign="center">
	 export a import nad tabulkou hesla<BR>
    export do suboru: <form method="post" action="export.php"> 
		<input type="text" name="file" value="export.xml" />
		<input type="submit" value="export">
    </form>
    import zo suboru: <form method="post" enctype="multipart/form-data" action="import.php"> 
		<input type="file" name="file" value=import.xml/>
