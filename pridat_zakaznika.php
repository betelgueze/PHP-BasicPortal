...
<TR height="70%">
	...
	<TD width="85%" colspan="2" align="center" valign="center"><h2>Pridat noveho zakazníka:</h2><br>
		<form method="post" action="pridat_zakaznika_sql.php">
			...
			Dulezitost(0-10 nejvyssi): <input type="text" name="dulezitost" size="20"><br><br>
			Login: <input type="text" name="login" size="20">
			Heslo: <input type="password" name="heslo" size="20"><br><br> 
			<input type="submit" value="Pridat zakaznika"> 
		</form> 
	</TD>
</TR>
</table>
